...
void setup() {
  ...
  pinMode(PIN_MOTEURJ_A1, OUTPUT);
  pinMode(PIN_MOTEURJ_A2, OUTPUT);
  pinMode(PIN_MOTEURJ_ENA, OUTPUT);
  pinMode(PIN_MOTEURJ_B1, OUTPUT);
  pinMode(PIN_MOTEURJ_B2, OUTPUT);
  pinMode(PIN_MOTEURJ_ENB, OUTPUT);
...
void loop() {
  ...
  //machine.run();
  // Serial.println("testMoteurGroupeJ");
  // testMoteurAStopGroupeJ();
  // testMoteurBStopGroupeJ();
  // delay(1000);
  // testMoteurAAvancerGroupeJ();
  // testMoteurBAvancerGroupeJ();
  // delay(1000);
  if (i ==0){
    // testMoteurAAvancerGroupeJ();
    // testMoteurBAvancerGroupeJ();
  ...
  //   // Reconstruire et afficher le chemin parcouru
    ...
    int* cheminReconstruit = antecedant( dijkstraph, goalNode, startNode);
